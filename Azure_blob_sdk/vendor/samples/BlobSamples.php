...
$connectionString = 'DefaultEndpointsProtocol=https;AccountName=farmerdisks608;AccountKey=Gg2CCjjwyeIYNg7GY57lOE08p8frAcb/YlN4oOWjLNi1wH8OcAFccBTk9T+5Z/nMfSArtoexeGiEWhDl7dFZsw==';
$blobClient = BlobRestProxy::createBlobService($connectionString);

$a = listBlobsSample($blobClient);
...
function listBlobsSample($blobClient)
{
    try {
        // List blobs.
        $blob_list = $blobClient->listBlobs("vhds");
